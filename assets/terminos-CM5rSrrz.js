import{n as e}from"./vendor-BBPjS4yS.js";import{t}from"./wii-DZw4TcJ0.js";import{O as n}from"./widev-Bh2jKAWA.js";import"./cookies-Dp2Jf9k3.js";var r=[{ico:`fa-user-shield`,color:`#0EBEFF`,num:`01`,tit:`Licencia de Uso de la Extensión`,body:`<p>WiiBlock es una extensión de navegador gratuita distribuida bajo la licencia estándar de software libre. Al descargar y utilizar nuestra herramienta, te comprometes a:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:`fa-clipboard-check`,color:`#29C72E`,num:`02`,tit:`Modificaciones del Software y Reglas`,body:`<p>El ecosistema web está en constante evolución y las reglas de publicidad cambian continuamente:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:`fa-eye-slash`,color:`#FF5C69`,num:`03`,tit:`Limitación de Responsabilidad`,body:`<p>WiiBlock se proporciona "tal cual" y "según disponibilidad", sin garantías de ningún tipo:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:`fa-copyright`,color:`#7000FF`,num:`04`,tit:`Propiedad Intelectual`,body:`<p>WiiBlock es propiedad de su desarrollador y la comunidad de código libre. Todos los derechos reservados ${n()}.</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:`fa-cloud-bolt`,color:`#FFDA34`,num:`05`,tit:`Almacenamiento Local y Caché`,body:`<p>Para optimizar la velocidad y permitir un funcionamiento inmediato:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:`fa-gavel`,color:`#0EBEFF`,num:`06`,tit:`Legislación y Jurisdicción`,body:`<p>Estos Términos y Condiciones se rigen bajo los principios de buena fe y las leyes que protegen el libre uso de software en internet.</p>
    <p>Cualquier disputa o consulta referente al comportamiento de la extensión será resuelta en los foros comunitarios oficiales de soporte.</p>`}],i=()=>`
<main id="wimain">
