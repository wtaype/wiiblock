...
`,i=()=>{t(`.pr_card, .pr_anim`,null,{anim:`pr_anim`,stagger:80}),console.log(`💳 ${e} 10 · Precios OK`)},a=()=>{console.log(`🧹 Precios limpiado`)};export{a as cleanup,i as init,r as render};