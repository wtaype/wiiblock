import{n as e}from"./vendor-BBPjS4yS.js";import{t}from"./wii-DZw4TcJ0.js";import{O as n}from"./widev-8sJg4_cC.js";import{r}from"./index-WaeVJtKe.js";import"./cookies-C5AISacK.js";var i=[{ico:`fa-database`,color:`#0EBEFF`,num:`01`,tit:`Información que Recopilamos`,body:`<p>Para nosotros, tu privacidad es un derecho fundamental e inalienable. Por ello, WiiBlock está construido bajo una estricta filosofía de cero recopilación de datos:</p>
    <ul class="tm_list">
    ...
    </div>`},{ico:`fa-gear`,color:`#29C72E`,num:`02`,tit:`Funcionamiento del Bloqueo Local`,body:`<p>WiiBlock utiliza la API nativa DeclarativeNetRequest de Google Chrome, garantizando la seguridad en el procesamiento de filtros:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:`fa-ban`,color:`#FF5C69`,num:`03`,tit:`Políticas de Publicidad y No Venta`,body:`<p>Al ser un bloqueador de anuncios independiente, mantenemos políticas de integridad inquebrantables:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:`fa-user-lock`,color:`#7000FF`,num:`04`,tit:`Configuración y Datos Guardados`,body:`<p>WiiBlock solo guarda preferencias técnicas de manera local en tu navegador Chrome:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:`fa-shield-halved`,color:`#FFDA34`,num:`05`,tit:`Permisos Requeridos y su Propósito`,body:`<p>Para cumplir con sus tareas protectoras, WiiBlock solicita únicamente los permisos estrictamente necesarios en Chrome:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:`fa-rotate`,color:`#0EBEFF`,num:`06`,tit:`Modificaciones de esta Política`,body:`<p>Podemos actualizar esta política para reflejar optimizaciones técnicas o adaptarnos a nuevas normativas exigidas por la Chrome Web Store.</p>
    <div class="tm_alert">
      <i class="fas fa-calendar-check"></i>
      <p>Última actualización: Mayo de ${n()} · Versión v10. El uso de WiiBlock confirma tu aceptación de estas directrices de privacidad y protección local.</p>
    </div>`}],a=()=>`
<main id="wimain">
  ...
  <section class="ac_hero tm_hero">
    ...
    <div class="ac_hero_body">
      ...
      <div class="tm_last_upd">
        <i class="fas fa-calendar-check"></i>
        Última actualización: Mayo ${n()} · Versión v10
      </div>
    </div>
  </section>
...
`,o=null,s=()=>{o=new IntersectionObserver(t=>t.forEach(t=>{t.isIntersecting&&e(t.target).addClass(`visible`)}),{threshold:.1}),e(`.wi_fadeUp`).each(function(){o.observe(this)}),e(document).on(`click.privacidad`,`.tm_nav`,function(t){t.preventDefault(),r(()=>import(`./index-WaeVJtKe.js`).then(t=>t.rutas.navigate(e(this).attr(`href`))),[])}),e(document).on(`click.privacidad`,`.tm_index_item`,function(t){t.preventDefault();let n=document.querySelector(e(this).attr(`href`));n&&window.scrollTo({top:n.getBoundingClientRect().top+scrollY-90,behavior:`smooth`})}),console.log(`🔒 ${t} Privacidad cargada`),window.__WIREADY__=!0},c=()=>{o?.disconnect?.(),o=null,e(document).off(`.privacidad`)};export{c as cleanup,s as init,a as render};