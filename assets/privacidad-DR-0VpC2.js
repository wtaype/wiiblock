import{n as e}from"./vendor-BBPjS4yS.js";import{t}from"./wii-DZw4TcJ0.js";import{O as n}from"./widev-pLzsDF2x.js";import{r}from"./index-B1RRCE2-.js";import"./cookies-DRKVUIql.js";var i=[{ico:`fa-database`,color:`#0EBEFF`,num:`01`,tit:`Información que Recopilamos`,body:`<p>Para nosotros, tu privacidad es un derecho fundamental e inalienable. Por ello, WiiBlock está construido bajo una estricta filosofía de cero recopilación de datos:</p>
    <ul class="tm_list">
...
`,o=null,s=()=>{o=new IntersectionObserver(t=>t.forEach(t=>{t.isIntersecting&&e(t.target).addClass(`visible`)}),{threshold:.1}),e(`.wi_fadeUp`).each(function(){o.observe(this)}),e(document).on(`click.privacidad`,`.tm_nav`,function(t){t.preventDefault(),r(()=>import(`./index-B1RRCE2-.js`).then(t=>t.rutas.navigate(e(this).attr(`href`))),[])}),e(document).on(`click.privacidad`,`.tm_index_item`,function(t){t.preventDefault();let n=document.querySelector(e(this).attr(`href`));n&&window.scrollTo({top:n.getBoundingClientRect().top+scrollY-90,behavior:`smooth`})}),console.log(`🔒 ${t} Privacidad cargada`),window.__WIREADY__=!0},c=()=>{o?.disconnect?.(),o=null,e(document).off(`.privacidad`)};export{c as cleanup,s as init,a as render};